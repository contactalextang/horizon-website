...
test('home feature cards share a bounded preview treatment', () => {
  ...
  assert.match(globals, /\.front-feature\s*{[^}]*height:\s*376px;/s)
  assert.match(globals, /\.front-feature\s*{[^}]*overflow:\s*hidden;/s)
